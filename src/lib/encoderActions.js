...
export const actionTypes = new Map([
  [ACTION_TYPE_KEY_PRESS, 'Key Press'],
  [ACTION_TYPE_MIDI_CONTROL_CHANGE, 'MIDI Control Change'],
  [ACTION_TYPE_MIDI_RGB_CHANGE, 'RGB Control'],
])

export const keyPressTypes = new Map([
  ['keyPress',                {name: 'Simple Key Press', desc: 'A standard key press, press and releas a key', functionCall: 'tap_code(%key%);'}],
